...
# lengths
additional_net_params["highway_length"] = 3000
...
# speed limits
additional_net_params["highway_speed"] = 100
additional_net_params["on_ramps_speed"] = 40
additional_net_params["off_ramps_speed"] = 40

# ramps
additional_net_params["on_ramps_pos"] = [400]
additional_net_params["off_ramps_pos"] = [2500]
...
def highway_ramps_example(render=None):
    ...
    sim_params = SumoParams(
        render=True,
        emission_path="./data/highway_ramp/",
